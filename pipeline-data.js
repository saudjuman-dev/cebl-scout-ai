...
const canadianPipeline = [
  ...
  { name: "Chris Boucher", pos: "C", age: 32, ht: "6'9\"", hometown: "Montreal, QC", team: "Fenerbahce", league: "EuroLeague", country: "Turkey", tier: "Europe-Elite", ppg: 8.5, rpg: 5.5, apg: 0.8, status: "Active", note: "Former Raptor. EuroLeague. Shot-blocking specialist.", college: "Oregon" },
  { name: "Kyle Wiltjer", pos: "F", age: 31, ht: "6'10\"", hometown: "Portland / CAN", team: "Olympiacos", league: "EuroLeague", country: "Greece", tier: "Europe-Elite", ppg: 9.2, rpg: 3.5, apg: 1.0, status: "Active", note: "Elite shooting big. Canadian international.", college: "Gonzaga" },
  { name: "Kevin Pangos", pos: "G", age: 31, ht: "6'1\"", hometown: "Newmarket, ON", team: "Zenit St. Petersburg", league: "VTB United League", country: "Russia", tier: "Europe-Elite", ppg: 10.5, rpg: 2.0, apg: 5.5, status: "Active", note: "Long EuroLeague career. Sharpshooting point guard.", college: "Gonzaga" },
  { name: "Khem Birch", pos: "C", age: 32, ht: "6'9\"", hometown: "Montreal, QC", team: "Virtus Bologna", league: "Italian Serie A", country: "Italy", tier: "Europe-Top", ppg: 6.8, rpg: 5.2, apg: 1.5, status: "Active", note: "Former Raptor and Magic. Veteran big man.", college: "UNLV" },
  { name: "Kassius Robertson", pos: "G", age: 29, ht: "6'3\"", hometown: "Toronto, ON", team: "Estudiantes", league: "ACB (Spain)", country: "Spain", tier: "Europe-Top", ppg: 11.0, rpg: 2.5, apg: 2.0, status: "Active", note: "Playing in top Spanish league.", college: "Missouri" },
  { name: "Melvin Ejim", pos: "F", age: 32, ht: "6'6\"", hometown: "Toronto, ON", team: "Tofas Bursa", league: "Turkey BSL", country: "Turkey", tier: "Europe-Top", ppg: 9.5, rpg: 5.0, apg: 1.5, status: "Active", note: "Canadian national team staple. Long Euro career.", college: "Iowa State" },
  { name: "Brady Heslip", pos: "G", age: 31, ht: "6'1\"", hometown: "Burlington, ON", team: "Bahcesehir Koleji", league: "Turkey BSL", country: "Turkey", tier: "Europe-Top", ppg: 8.5, rpg: 1.5, apg: 2.0, status: "Active", note: "Elite 3-point shooter. National team.", college: "Baylor" },

  // ==================== EUROPE - MID TIER ====================
  { name: "Thomas Kennedy", pos: "F", age: 28, ht: "6'7\"", hometown: "Mississauga, ON", team: "Rytas Vilnius", league: "LKL (Lithuania)", country: "Lithuania", tier: "Europe-Mid", ppg: 11.5, rpg: 4.0, apg: 1.5, status: "Active", note: "Former CEBL MVP. Now in Europe.", college: "George Mason" },
  { name: "Nate Darling", pos: "G", age: 27, ht: "6'5\"", hometown: "Fredericton, NB", team: "Bursaspor", league: "Turkey BSL", country: "Turkey", tier: "Europe-Mid", ppg: 14.5, rpg: 3.0, apg: 2.5, status: "Active", note: "Former Hornets. Explosive scorer.", college: "Delaware" },
  { name: "Phil Scrubb", pos: "G", age: 31, ht: "6'3\"", hometown: "Richmond, BC", team: "Heroes Den Bosch", league: "BNXT League", country: "Netherlands", tier: "Europe-Mid", ppg: 13.2, rpg: 3.5, apg: 5.0, status: "Active", note: "Veteran Canadian PG. Long international career.", college: "Carleton" },
  { name: "Thomas Scrubb", pos: "F", age: 31, ht: "6'7\"", hometown: "Richmond, BC", team: "Nantes", league: "France Pro B", country: "France", tier: "Europe-Mid", ppg: 10.0, rpg: 5.0, apg: 1.5, status: "Active", note: "Phil's twin. Versatile forward.", college: "Carleton" },
  { name: "Conor Morgan", pos: "F", age: 28, ht: "6'8\"", hometown: "Mississauga, ON", team: "Ironi Ness Ziona", league: "Israeli Premier", country: "Israel", tier: "Europe-Mid", ppg: 10.0, rpg: 5.5, apg: 1.0, status: "Active", note: "Former CEBL standout. Physical Canadian forward.", college: "St. Bonaventure" },
  ...
  { name: "Aaron Best", pos: "G", age: 26, ht: "6'3\"", hometown: "Toronto, ON", team: "Fribourg Olympic", league: "Swiss SBL", country: "Switzerland", tier: "Europe-Mid", ppg: 14.0, rpg: 3.0, apg: 3.5, status: "Active", note: "Former CEBL guard. Now in Swiss league.", college: "Stony Brook" },
  { name: "Kassius Robertson", pos: "G", age: 29, ht: "6'3\"", hometown: "Toronto, ON", team: "Estudiantes", league: "ACB (Spain)", country: "Spain", tier: "Europe-Top", ppg: 11.0, rpg: 2.5, apg: 2.0, status: "Active", note: "Playing in top Spanish league.", college: "Missouri" },
  ...
  { name: "Mfiondu Kabengele", pos: "C", age: 27, ht: "6'10\"", hometown: "Toronto, ON", team: "Cholet Basket", league: "France LNB Pro A", country: "France", tier: "Europe-Mid", ppg: 8.5, rpg: 5.5, apg: 0.8, status: "Active", note: "Former Clippers/Cavs. French league.", college: "Florida State" },
  ...
  // ==================== AUSTRALIA NBL ====================
  { name: "Xavier Rathan-Mayes", pos: "G", age: 29, ht: "6'3\"", hometown: "Scarborough, ON", team: "Cairns Taipans", league: "Australia NBL", country: "Australia", tier: "Australia", ppg: 15.5, rpg: 3.0, apg: 5.0, status: "Active", note: "FSU product. Prolific scorer.", college: "Florida State" },
  ...
  // ==================== MEXICO / AMERICAS ====================
  { name: "Mychal Mulder", pos: "G", age: 29, ht: "6'3\"", hometown: "Windsor, ON", team: "Fuerza Regia", league: "LNBP (Mexico)", country: "Mexico", tier: "Americas", ppg: 15.0, rpg: 2.5, apg: 2.0, status: "Active", note: "Former Warriors. Now in Mexican league.", college: "Kentucky" },

  // ==================== CEBL STARS ====================
  { name: "Xavier Moon", pos: "G", age: 28, ht: "6'1\"", hometown: "Goodwater, AL", team: "Brampton Honey Badgers", league: "CEBL", country: "Canada", tier: "CEBL", ppg: 17.5, rpg: 3.5, apg: 6.5, status: "Active", note: "CEBL legend. Multiple championships. NBA stint with Clippers.", college: "Morehead State" },
  { name: "Trae Bell-Haynes", pos: "G", age: 28, ht: "6'2\"", hometown: "Toronto, ON", team: "Ottawa BlackJacks", league: "CEBL", country: "Canada", tier: "CEBL", ppg: 14.0, rpg: 3.0, apg: 5.5, status: "Active", note: "Multi-year CEBL star. Canadian national team.", college: "Vermont" },
  ...
  { name: "Khalil Ahmad", pos: "G", age: 28, ht: "6'3\"", hometown: "Chicago, IL", team: "Edmonton Stingers", league: "CEBL", country: "Canada", tier: "CEBL", ppg: 18.5, rpg: 4.0, apg: 3.0, status: "Active", note: "Adopted Canadian star.", college: "Cal State Fullerton" },
